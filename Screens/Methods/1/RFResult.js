...
const ResultScreen = ({ route }) => {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <Text style={[styles.cell, { backgroundColor: '#001524' }]}>{item.fa}</Text>
      <Text style={[styles.cell, { backgroundColor: 'black' }]}>{item.fb}</Text>
          ...
          <FlatList
            ...
            ListHeaderComponent={() => (
              <View style={styles.headerRow}>
                ...
                <Text style={[styles.headerCell, { backgroundColor: '#001524' }]}>fa</Text>
                <Text style={[styles.headerCell, { backgroundColor: 'black' }]}>fb</Text>
